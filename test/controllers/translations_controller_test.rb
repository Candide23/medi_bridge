...
class TranslationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create translation" do
    assert_difference("Translation.count") do
      post translations_url, params: { translation: { content: @translation.content, health_record_id: @translation.health_record_id, language: @translation.language } }
    end
  ...
  test "should update translation" do
    patch translation_url(@translation), params: { translation: { content: @translation.content, health_record_id: @translation.health_record_id, language: @translation.language } }
