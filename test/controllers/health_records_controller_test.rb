...
class HealthRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create health_record" do
    assert_difference("HealthRecord.count") do
      post health_records_url, params: { health_record: { language: @health_record.language, record_type: @health_record.record_type, user_id: @health_record.user_id } }
    end
  ...
  test "should update health_record" do
    patch health_record_url(@health_record), params: { health_record: { language: @health_record.language, record_type: @health_record.record_type, user_id: @health_record.user_id } }
